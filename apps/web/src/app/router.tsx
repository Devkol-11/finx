...
const DepositPage = lazy(() => import("@/features/wallet/deposit-page"));
const WithdrawPage = lazy(() => import("@/features/wallet/withdraw-page"));
const TransfersPage = lazy(() => import("@/features/wallet/transfers-page"));
        ...
        children: [
          {
            ...
            children: [
              ...
              { path: "wallet", element: lazyPage(<WalletPage />) },
              { path: "wallet/deposit", element: lazyPage(<DepositPage />) },
              { path: "wallet/withdraw", element: lazyPage(<WithdrawPage />) },
              { path: "transfers", element: lazyPage(<TransfersPage />) },
